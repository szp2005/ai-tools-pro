...
*   **Large Language Models (LLMs):** These form the "brain" of the agents, enabling them to understand natural language queries, process text, reason, summarize, and generate human-like responses. Models like GPT-4, Claude, or Llama 3 are commonly used.
